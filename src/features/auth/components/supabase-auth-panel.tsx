...
export function SupabaseAuthPanel({
  ...
  const modeCopy = useMemo(() => {
    ...
    return {
      ...
      submitLabel: 'Sign in',
      helper:
        'Use your email and password, or continue with Google if that is how you prefer to log in.',
  ...
  async function handleEmailSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (mode === 'create-account') {
      ...
      setIsSubmitting(false)
      setSuccessMessage(
        'Account created. Check your email if confirmation is required, then come back and sign in.'
      )
      return
    }
    ...
    <div className='space-y-6'>
      ...
      <div className='relative'>
        ...
        <div className='relative flex justify-center text-xs uppercase'>
          <span className='bg-white px-2 font-medium tracking-[0.16em] text-slate-400'>
